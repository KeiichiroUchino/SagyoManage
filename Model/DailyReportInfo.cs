...
{
    /// <summary>
    /// 日報情報のエンティティコンポーネントを作成します。
    /// </summary>
    [Serializable]
    public class DailyReportInfo : AbstractSequenceKeyTimeStampModelBase
    {
        /// <summary>
        /// 日報IDを取得・設定します。
        /// </summary>
        public decimal DailyReportId
        {
    ...
    /// <summary>
    /// 日報検索条件情報のエンティティコンポーネントを作成します。
    /// </summary>
    [Serializable]
    public class DailyReportSearchParameter
    {
        /// <summary>
        /// 日報IDを取得・設定します。
        /// </summary>
