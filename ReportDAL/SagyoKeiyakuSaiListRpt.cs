...
{
    /// <summary>
    /// 作業契約差異リスト情報のデータアクセスレイヤです。
    /// </summary>
    public class SagyoKeiyakuSaiListRpt
    {
        ...
        /// <summary>
        /// 作業契約差異リストクラスのデフォルトコンストラクタです。
        /// </summary>
        public SagyoKeiyakuSaiListRpt()
        {
        }

        /// <summary>
        /// アプリケーション認証情報を指定して、作業契約差異リスト情報の
        /// データアクセスレイヤのインスタンスを初期化します。
        /// </summary>
        /// <param name="authInfo">アプリケーション認証情報</param>
        public SagyoKeiyakuSaiListRpt(AppAuthInfo authInfo)
        {
        ...
        /// <summary>
        /// 検索条件情報を指定して、作業契約差異リスト情報のリストを取得します。
        /// </summary>
        /// <param name="para">検索条件情報</param>
        /// <returns>作業契約差異リスト情報のリスト</returns>
        ...
        public IList<GekkanSagyoKeikakuhyouRptInfo> GetListInternal(SqlTransaction transaction, GekkanSagyoKeikakuhyouRptInfoSearchParameter para)
        {
            ...
            return SQLHelper.SimpleRead(mySql, rdr =>
            {
                ...
                GekkanSagyoKeikakuhyouRptInfo rt_info = new GekkanSagyoKeikakuhyouRptInfo
                {
                    ...
                    YoteiJinin = "",
                    SagyoCode = rdr["SagyoShoBunruiCode"].ToString(),
        ...
        /// <summary>
        /// 作業契約差異リスト情報を取得するSQLを作成します。
        /// </summary>
        /// <param name="info">作業契約差異リスト情報</param>
        /// <returns></returns>
        private string GetQuerySelect(GekkanSagyoKeikakuhyouRptInfoSearchParameter para)
        {
            ...
            sb.AppendLine("   , SagyoBasho.SagyoBashoId ");
