...
{
    public partial class GekkanSagyoKeikakuhyouPrtToFrame : Form, IFrameBase
    {
        #region コンストラクタ
        ...
        /// 本クラスのデフォルトコンストラクタです。
        /// </summary>
        public GekkanSagyoKeikakuhyouPrtToFrame()
        {
            InitializeComponent();
        }
        ...
        /// 画面のタイトル
        /// </summary>
        private const string WINDOW_TITLE = "月間作業計画表";
        ...
        /// 作業計画書（月単位）クラス
        /// </summary>
        private GekkanSagyoKeikakuhyouRpt _GekkanSagyoKeikakuhyouRpt;
        ...
        private void InitJuchuNyuryokuFrame()
        {
            ...
            //画面コントローラのインスタンスを作成
            this._GekkanSagyoKeikakuhyouRpt = new GekkanSagyoKeikakuhyouRpt();
        ...
        private void StartReportCreate()
        {
            lock (this)
            {
                ...
                //印刷用データを取得
                this._RptList = this._GekkanSagyoKeikakuhyouRpt.GetList(this._ArgInfo);
        ...
        private void DoPrintReport(IList[] reportDataArray, ReportPrintDestType printDestType)
        {
            try
            {
                ...
                //レポートオブジェクト作成
                GekkanSagyoKeikakuhyouToRpt rpt = new GekkanSagyoKeikakuhyouToRpt();
                //レポートをロード
                rpt.Load();
                ////レポートに印刷データをセット
