...
{
    public partial class CmnSearchStaffFrame : Form, IFrameBase
    {
        #region ユーザ定義
        ...
        /// 画面タイトルの静的な部分
        /// </summary>
        private const string WINDOW_TITLE = "社員検索";
        ...
        /// 検索テーブルのクラス領域
        /// </summary>
        private Jpsys.SagyoManage.SQLServerDAL.Staff searchTblClass;
        ...
        private void InitCmnSearchStaffFrame()
        {
            //画面タイトルの設定
            ...
            //検索テーブルのクラスインスタンス作成
            this.searchTblClass = new Jpsys.SagyoManage.SQLServerDAL.Staff();
        ...
        private void DoGetData()
        {
            //社員一覧を取得
            this.StaffList =
                this.searchTblClass.GetList(new StaffSearchParameter() { });
        }
        ...
        private void SetListSheet()
        {
            ...
            try
            {
                ...
                List<StaffInfo> wk_list =
                    this.GetMatchedList(this.StaffList).OrderBy(x => x.StaffCode).ToList();
                ...
                for (int j = 0; j < wk_list.Count; j++)
                {
                    ...
                    //データモデルのセット
                    datamodel.SetValue(j, COL_CODE, wk_info.StaffCode);
                    datamodel.SetValue(j, COL_NAME, wk_info.StaffName);
                    datamodel.SetValue(j, COL_KBN, wk_info.StaffKbnName);
        ...
        private List<StaffInfo> GetMatchedList(IList<StaffInfo> list)
        {
            ...
            foreach (StaffInfo item in wk_list)
            {
                ...
                string item_mei =
                    ...
                    + item.StaffKbnName.Trim() + Environment.NewLine;
        ...
        private void CmnSearchStaffFrame_KeyDown(object sender, KeyEventArgs e)
        {
