...
{
    public partial class CmnSearchJuchuTantoshaFrame : Form, IFrameBase
    {
        #region ユーザ定義
        ...
        /// 画面タイトルの静的な部分
        /// </summary>
        private const string WINDOW_TITLE = "受注担当者検索";
        ...
        /// 検索テーブルのクラス領域
        /// </summary>
        private Jpsys.HaishaManageV10.SQLServerDAL.Staff searchTblClass;

        /// <summary>
        /// 受注担当社情報のリストを保持する領域
        /// </summary>
        private IList<StaffInfo> StaffList = null;
        ...
        /// 本クラスのデフォルトコンストラクタです。
        /// </summary>
        public CmnSearchJuchuTantoshaFrame()
        {
            InitializeComponent();
        }
        ...
        private void InitCmnSearchJuchuTantoshaFrame()
        {
            //画面タイトルの設定
            ...
            //検索テーブルのクラスインスタンス作成
            this.searchTblClass = new Jpsys.HaishaManageV10.SQLServerDAL.Staff();
        ...
        private void SetupValidatingEventRaiser()
        {
            ...
            //    ControlValidatingEventRaiser.Create(this.edtStaffMei, ctl => ctl.Text, this.edtStaffMei_Validating));
        }
        ...
        private void DoGetData()
        {
            //受注担当者一覧を取得
            this.StaffList =
                this.searchTblClass.GetList(new StaffSearchParameter() { JuchuTantoshaFlag = true });
        }
        ...
        private void SetListSheet()
        {
            ...
            try
            {
                ...
                //抽出後のリストを取得（同時に並べ替え）
                List<StaffInfo> wk_list =
                    this.GetMatchedList(this.StaffList).OrderBy(x => x.ToraDONStaffCode).ToList();
                ...
                for (int j = 0; j < wk_list.Count; j++)
                {
                    ...
                    //データモデルのセット
                    datamodel.SetValue(j, COL_CODE, wk_info.ToraDONStaffCode);
                    datamodel.SetValue(j, COL_NAME, wk_info.ToraDONStaffName);
                    datamodel.SetValue(j, COL_KANA, wk_info.ToraDONStaffNameKana);
        ...
        private List<StaffInfo> GetMatchedList(IList<StaffInfo> list)
        {
            ...
            foreach (StaffInfo item in wk_list)
            {
                //「コード」+「名称」+「カナ」であいまい検索
                string item_mei =
        ...
        /// <summary>
        /// 選択している受注担当者情報をメンバにセットします。
        /// </summary>
        private void SetSelectedInfo()
        {
            List<StaffInfo> wk_val = this.GetInfoByListOnSelection();
        ...
        /// <summary>
        /// 一覧にて選択中の受注担当者情報を取得します。
        /// </summary>
        /// <returns>受注担当者情報</returns>
        private List<StaffInfo> GetInfoByListOnSelection()
        {
            List<StaffInfo> rt_list = new List<StaffInfo>();
            ...
            if (sheet0.SelectionCount > 0)
            {
                ...
                foreach (CellRange item in sheet0.GetSelections())
                {
                    ...
                    {
                        StaffInfo info =
                            ((StaffInfo)sheet0.Cells[item.Row + i, COL_CODE].Tag);
        ...
        /// 選択された検索テーブル情報を取得します。
        /// </summary>
        public StaffInfo SelectedInfo { get; private set; }

        /// <summary>
        /// 選択された受注担当者情報を一覧で取得します。
        /// </summary>
        public List<StaffInfo> SelectedInfoList { get; private set; }
        ...
        {
            this.InitCmnSearchJuchuTantoshaFrame();
        }
        ...
        private void CmnSearchJuchuTantoshaFrame_KeyDown(object sender, KeyEventArgs e)
        {
