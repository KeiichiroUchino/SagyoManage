...
{
    public partial class CmnSearchDriverFrame : Form, IFrameBase
    {
        #region ユーザ定義
        ...
        /// 画面タイトルの静的な部分
        /// </summary>
        private const string WINDOW_TITLE = "運転者検索";
        ...
        private void InitCmnSearchDriverFrame()
        {
            //画面タイトルの設定
        ...
        private void DoGetData()
        {
            //運転者一覧を取得
            this.StaffList =
                this.searchTblClass.GetList(new StaffSearchParameter() { DriverFlag = true });
        }
        ...
        private void CmnSearchDriverFrame_KeyDown(object sender, KeyEventArgs e)
        {
